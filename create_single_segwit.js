...
fs.writeFileSync('create_key_single_segwit.dat', ret1);
...
let cred = ireneKeys.createCredentials(null, { coin: 'btc', network: 'livenet', account: 0, n: 1, addressType: 'P2WPKH' });
client.fromObj(cred);
console.log("################");
console.log(client.credentials);

client.createWallet("My Wallet", "Irene", 1, 1, {network: 'livenet', useNativeSegwit: true }, function(err, secret) {
  if (err) {
  ...
  fs.writeFileSync('create_single_segwit.dat', ret);
