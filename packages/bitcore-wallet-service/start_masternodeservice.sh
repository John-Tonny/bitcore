...
./stop_bws.sh pids/masternodeservice.pid
run_program ./ts_build/masternodeservice/masternodeservice.js pids/masternodeservice.pid logs/masternodeservice.log
